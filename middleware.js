...
export async function middleware(req) {
  ...
  const staticFileExtensions = ["jpg", "jpeg", "png", "gif", "ico", "css", "js", "svg", "woff", "woff2", "ttf", "eot", "webp", "mp4", "webm", "mp3", "wav", "pdf", "zip", "rar", "tar", "gz"];
  const isStaticFile = staticFileExtensions.some(ext => pathname.toLowerCase().endsWith(`.${ext}`));
  const isNextStatic = pathname.startsWith("/_next/") || pathname.startsWith("/_next/image") || pathname.startsWith("/_next/data");
